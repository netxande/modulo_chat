...
class ConsumersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consumer" do
    assert_difference('Consumer.count') do
      post consumers_url, params: { consumer: { author: @consumer.author, description: @consumer.description, token: @consumer.token } }
    end
  ...
  test "should update consumer" do
    patch consumer_url(@consumer), params: { consumer: { author: @consumer.author, description: @consumer.description, token: @consumer.token } }
